...
var peticion = "Pedro por favor responde esta pregunta tan importante"
...
*/
function preguntar() {
    var re = ""; //va a almacenar el texto de punt o a punto
    ...
    if (!(pos1 == -1 || pos2 == -1)) {
        respuesta.innerHTML = "Respuesta: " + re; //retorna la respuesta al usuario
    } else {
